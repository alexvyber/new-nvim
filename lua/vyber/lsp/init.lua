local imap = require("vyber.keymap").imap
local nmap = require("vyber.keymap").nmap
...
local telescope_mapper = require("vyber.telescope.mappings")
local handlers = require("vyber.lsp.handlers")
...
local status = require("vyber.lsp.status")
status.activate()
...
local custom_attach = function(client)
	...
	buf_nnoremap({ "<space>lr", "<cmd>lua R('vyber.lsp.codelens').run()<CR>" })
